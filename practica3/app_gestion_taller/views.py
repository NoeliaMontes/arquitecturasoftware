...
def detalle_cliente(request, cliente_id):
    try:
        ...
        #En la práctica 5 añadimos la búsqueda de coches de un cliente
...
def buscar_coche_por_matricula(request, matricula):
    try:
        coche = Coche.objects.values("id", "marca", "modelo", "matricula").get(matricula=matricula)
...
def servicio_coche(request):
    ...
    return render(request, 'app_gestion_coches/formulario.html', {'form': form, 'titulo': 'Servicio a un Coche'})